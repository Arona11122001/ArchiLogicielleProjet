<?php
$options = array(
    'location' => 'http://localhost/projetDiop2/ArchitectureLogicielleTP/Soap/soap_server.php',
    'uri'      => 'http://localhost/projetDiop2/ArchitectureLogicielleTP/Soap/soap_server.php',
    'trace'    => 1
);
